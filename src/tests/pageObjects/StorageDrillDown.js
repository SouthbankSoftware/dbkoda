 ...
 */
 ...
 export default class StorageDrillDown extends Page {
   ...
   _getChartTableHeadRow(idxData) {
     return this.browser.elements('.StorageSunburstView .list thead tr th:nth-child(' + idxData + ')').getText();
   }

   _getChartTableBodyRow(idxRow, idxData) {
     return this.browser.elements('.StorageSunburstView .list tbody tr:nth-child(' + idxRow + ') td:nth-child(' + idxData + ')').getText();
   }
 }
